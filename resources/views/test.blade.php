...
<head>
    ...
    <!-- Lien vers le CSS (reset et test) -->
...
<body>
    ...
    <!-- Formulaire complet, contenant le champ email et toutes les questions. Masqué tant qu’on est à l’étape intro -->
    <form action="{{ url('/test-submit') }}" method="POST" id="testForm" style="display:none;">
        @csrf

        <h1>Test Jane Orientation</h1>

        <!-- Step 1 : Insertion de l'email -->
        <div class="question email-step" id="q1">
            <p>Veuillez insérer votre email avant de commencer afin de recevoir vos résultats par email</p>
            <div class="input-container">
                <span>@</span>
                <input type="email" id="user-email" name="email" required placeholder="Entrez votre email">
            </div>
            <div class="test-btn-container">
                <!-- Pour cette étape, aucun bouton "Précédent", uniquement "Suivant" -->
        ...
        <div class="question" id="q10">
            ...
            <div class="test-btn-container">
                ...
                <button type="button" class="test-btn next-btn" data-next="q11">
                    <i class="fa fa-caret-right" aria-hidden="true"></i>
                </button>
            </div>
        </div>
        ...
        <div class="question" id="q11">
            ...
            <div class="test-btn-container">
                <button type="button" class="test-btn prev-btn" data-prev="q10">
                    <i class="fa fa-caret-left" aria-hidden="true"></i>
                </button>
                <button type="submit" class="test-btn submit-btn">Voir et recevoir le résultat</button>
            </div>
        </div>
    </form>
